...
#    CampaignsURL = 'https://api.direct.yandex.com/json/v5/campaigns'
    ...
    NegativeKeywords = ['root', 'xxx', 'анал', 'баб', 'бляди', 'бородина', 'вдул', 'ветеран', 'выебал', 'груповуха', 'групповуха', 'групповушка', 'девок', 'долбят', 'дура', 'дятел', 'ебут', 'жопу', 'загир', 'задорнов', 'инцест', 'клип', 'кредо', 'леруа', 'люби', 'мжм', 'минет', 'минетчицы', 'небритый', 'оргазм', 'отъебал', 'пацаны', 'пенсия', 'пизда', 'пиздень', 'попка', 'попу', 'порево', 'порноролики', 'порнуха', 'приколы', 'рич', 'рот', 'сисястую', 'солнце', 'сон', 'сонник', 'сосет', 'таверна', 'телки', 'толстухи', 'трах', 'трахал', 'трахнул', 'фистинг', 'хворостовский', 'хуй', 'ххх', 'целка', 'шалава', 'эротика']
